...
<div id="arrow" tabindex="0" role="button" on:click={change_info} on:keypress={(e) => e.key === 'Enter' && change_info()}><div class="{className1}"></div></div><h2 tabindex="0" role="button" on:click={change_info} on:keypress={(e) => e.key === 'Enter' && change_info()} class="how">How does GPA calculation work ?</h2></div>
{#if show_info===false}
<div class="info">
